...
- Codex TOML profiles are copied. Do not replace them with symlinks or overwrite runtime state as part of a repository edit.
- Pi `settings.json` is symlinked to dotfiles by user choice. Pi settings changes can update the tracked file.
